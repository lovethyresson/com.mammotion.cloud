...
// Alibaba Cloud IoT App credentials (from PyMammotion)
...
// Alibaba Cloud OpenAccount endpoints
const ALIYUN_OPENACCOUNT_URL = 'https://sdk.openaccount.aliyun.com';
...
const MODEL_PATTERNS = {
  LUBA: {
    ...
    excludePatterns: ['luba2', 'luba-2', 'luba 2'],
  },
  LUBA_2: {
    patterns: ['luba2', 'luba-2', 'luba 2', 'Luba2'],
  },
  YUKA: {
    patterns: ['yuka'],
  },
